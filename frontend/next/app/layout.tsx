...
const CSP = process.env.NODE_ENV === "production"
  ? `default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob:; font-src 'self' data:; connect-src 'self' ${new URL(API_BASE).host}; frame-src 'none'; object-src 'none'; base-uri 'self'`
  : "";

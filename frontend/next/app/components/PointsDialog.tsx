...
export default function PointsDialog({
  ...
  const POINT_DEPS: Record<string, string[]> = {
    ...
    "文章右上角3点": ["点击微信左上角搜索输入框", "微信左上角搜索网络", "微信窗口初始化不合法时窗口分离按钮", "搜一搜窗口查询按钮", "文章列表左上角", "文章列表右下角"],
    "文章底部数据栏左上": ["点击微信左上角搜索输入框", "微信左上角搜索网络", "微信窗口初始化不合法时窗口分离按钮", "搜一搜窗口查询按钮", "文章列表左上角", "文章列表右下角", "文章右上角3点"],
    "文章底部数据栏右下": ["点击微信左上角搜索输入框", "微信左上角搜索网络", "微信窗口初始化不合法时窗口分离按钮", "搜一搜窗口查询按钮", "文章列表左上角", "文章列表右下角", "文章右上角3点"],
    "阅读数左上": ["文章底部数据栏左上"],
    "阅读数右下": ["文章底部数据栏左上"],
  };
